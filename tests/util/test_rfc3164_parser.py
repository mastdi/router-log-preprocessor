...
def test_parse_with_space_in_process_name():
    message = "<8>Apr 17 16:50:10 GT-AX11000-ABCD-1234567-E Samba Server: smb daemon is stopped"
...
def test_parse_with_space_in_process_name_and_a_process_id():
    message = "<8>Apr 17 16:50:10 GT-AX11000-ABCD-1234567-E Samba Server[23993]: smb daemon is stopped"
    expected_record = router_log_preprocessor.util.rfc3164_parser.LogRecord(
        facility=1,
        severity=0,
        timestamp=router_log_preprocessor.util.rfc3164_parser.timestamp_to_datetime(
